(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".repair__slider")) new swiper_core_Swiper(".repair__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".body-sermons__slider")) new swiper_core_Swiper(".body-sermons__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".body-worship__slider")) new swiper_core_Swiper(".body-worship__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
